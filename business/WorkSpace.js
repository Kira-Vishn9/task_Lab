...
class WorkSpace extends BasePage {
    ...
    async createBoard() {
        ...
        await this.inputText("[data-testid='create-board-title-input']", "Board created from Workspace");
    ...
    async editWorkspaceName() {
        ...
        await this.BP(5000);
        await this.inputText('#displayName', 'Рабочее пространство Trello Automate');
        await this.click('._wJD3QSFJjW4Pb.bxgKMAm3lq5BpA.SdamsUKjxSBwGb.SEj5vUdI3VvxDc');
    }
}
